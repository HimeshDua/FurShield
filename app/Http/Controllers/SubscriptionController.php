...
class SubscriptionController
{
    public function index()
    {
        ...
        $subsByService = OwnerSubscription::query()
            ->where('user_id', $userId)
            ->get(['product_id', 'package_name', 'status'])
        ...
        $productIds = array_keys($subsByService);

        $customerServices = Product::whereIn('id', $productIds)->get();
